...
import styles from "./MeanGuyAvtarChatPage.module.css";

const MeanGuyAvtarChatPage = () => {
  const navigate = useNavigate();
  const [message, setMessage] = useState("");
  const [chatMessages, setChatMessages] = useState([
    { text: "Oh great, another human wanting to chat. What do you want? Make it quick.", isUser: false }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setChatMessages(prev => [...prev, { text: "Server's down. Not that I care. Try again or don't. Whatever.", isUser: false }]);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className={styles.meanGuyAvtarChatPage}>
        ...
        <div className={styles.chatArea}>
          ...
          <div className={styles.inputContainer}>
            <input
              ...
              placeholder="Type something... if you must"
              type="text"
              value={message}
...
export default MeanGuyAvtarChatPage;